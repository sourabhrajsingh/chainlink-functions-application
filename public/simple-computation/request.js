...
const functionsConsumerAbiJson = require("../../out/FunctionsConsumer.sol/FunctionsConsumerExample.json");
const functionsConsumerAbi = functionsConsumerAbiJson.abi;
const { ethers } = require("ethers");
const { JsonRpcProvider } = require("@ethersproject/providers");

require("@chainlink/env-enc").config({ path: "../../.env.enc" });

const consumerAddress = "0x52bdb11693662e17b67c0f15dfae080733c4055b"; // REPLACE this with your Functions consumer address
const subscriptionId = 172; // REPLACE this with your subscription ID
...
const makeRequestSepolia = async () => {
  ...
  const rpcUrl = process.env.ARBITRUM_SEPOLIA_URL; // fetch Sepolia RPC URL
